...
| Component                         | Change Type                         | Original                                 | Current (Rev 3 + Link Tracking)                                                                                                                                                          | Rationale                                                         | Cost Impact                                        |
| --------------------------------- | ----------------------------------- | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- | -------------------------------------------------- |
| **CO₂ Cartridge**          | [OK] No change                        | Umarex 88g M16×1.5                      | Same<br>Link (Before): https://airgunking.com/umarex-pre-filled-disposable-88-gram-co2-cartridges-2pk/<br>Link (After): Same as Before                                             | Verified compatible                                               | ₹0                                                |
| **Pressure Regulator**      | [OK] Verify only                      | Airmax 0–42 bar −20°C                 | Same (verify seal material)<br>Link (Before): https://www.amazon.in/Airmax-Pneumatic-Pressure-Regulator-0-42Kg/dp/B0C4T5F9X2<br>Link (After): Same as Before                        | Request datasheet confirmation                                    | ₹0                                                |
| **QEV**                     | [SUBSTITUTED] **SUBSTITUTED**             | **Airmax AQEV (NBR seals)**        | **SMC AQ2110A-N02 (PTFE seals)**<br>Link (Before): [ADD OLD AIRMAX QEV LINK]<br>Link (After): https://moglix.com/ (search: SMC AQ2110A-N02)                                          | **NBR fails <−15°C; PTFE required for CO₂ duty**         | **+₹3,155–4,080**                          |
| **Pilot Solenoid**          | [OK] Validate only                    | Generic 12V DC                           | Same (verify −20°C rating)<br>Link (Before): https://robu.in/product/dc-12v-solenoid-valve-1-4-2-way-normally-closed-direct-pneumatic-valves-for-water-air-gas-hot<br>Link (After): Same as Before | Request cold-temp datasheet                                       | ₹0                                                |
| **PRV**                     | [OK] Verify only                      | Brass 18 bar set                         | Same (confirm set point)<br>Link (Before): https://www.indiamart.com/proddetail/pop-action-valve-21281555012.html<br>Link (After): Same as Before                                   | Verify 18 bar (not range)                                         | ₹0                                                |
| **Barrel Tube**             | [CLARIFIED] **SPECIFICATION CLARIFIED** | ±0.3 mm (vague)                         | **±0.3 mm via honing (explicit); Ra < 0.8 μm; cert required**<br>Link (Before): https://dir.indiamart.com/impcat/aluminum-tubes.html<br>Link (After): Same as Before (plus local honing supplier) | **Mill tolerance insufficient; require precision service**  | **+₹700–1,500**                            |
| **Aluminium Frame**         | [OK] No change                        | 25×25 mm 6061 Al bar                    | Same<br>Link (Before): https://www.indiamart.com/proddetail/aluminum-tubes-21949662962.html<br>Link (After): Same as Before                                                          | Standard sourcing                                                 | ₹0                                                |
| **Charge Chamber**          | [CLARIFIED] **OPTION A LOCKED**         | "Option A or B" (choice)                 | **Option A: 50 mm hydraulic cylinder + Al caps + hydrostatic test (MANDATORY)**<br>Link (Before): https://dir.indiamart.com/impcat/hydraulic-cylinders.html<br>Link (After): Same as Before | **Clarify design; add safety test gate**                    | **Cost stabilized ₹1,200–2,000**           |
| **Pressure Gauge**          | [OK] No change                        | JIVTO 0–25 bar                          | Same (offer local suppliers alternative)<br>Link (Before): https://www.amazon.in/Pressure-Liquid-Connection-Polycarbonate-Stainless/dp/B0865QG6WQ?th=1<br>Link (After): Same as Before | Standard sourcing                                                 | ₹0 (or −₹1,500 if local supplier used)          |
| **Pressure Transducer**     | [OK] No change                        | M5200 0–20 bar                          | Same (optional, defer to T3)<br>Link (Before): https://www.indiamart.com/proddetail/m5200-pressure-transducer-23694850630.html<br>Link (After): Same as Before                      | Test instrumentation                                              | ₹0                                                |
| **Manual Pilot Valve**      | [OK] No change                        | Janatics 3/2 1/4" NPT                    | Same<br>Link (Before): https://pneucons.com/1-4-3-2-hand-lever-operated-valve-with-spring-return-ds245hr61-janatics.html<br>Link (After): Same as Before                            | Standard sourcing                                                 | ₹0                                                |
| **Brass Fittings**          | [OK] No change                        | 1/4" + 3/4" NPT fittings                 | Same<br>Link (Before): https://www.amazon.in/s?k=brass+pneumatic+fittings+NPT<br>Link (After): Same as Before                                                                         | Standard sourcing                                                 | ₹0                                                |
| **Arduino Nano + Relay**    | [OK] No change                        | CH340G clone + relay                     | Same (optional, autonomous only)<br>Link (Before): https://www.amazon.in/Electrobot-ATmega328P-Withou-Compatible-Arduino/dp/B08QVYXXY3?th=1<br>Link (After): Same as Before         | Cost-optimized                                                    | ₹0                                                |
| **3S LiPo (Launcher)**      | [OK] No change                        | 1000–1500 mAh 30C+                      | Same (optional, autonomous only)<br>Link (Before): https://robu.in/product/pro-range-11-1v-1000mah-30c-3s-lithium-polymer-battery-pack<br>Link (After): Same as Before              | Standard sourcing                                                 | ₹0                                                |
| **Arming Key Switch**       | [OK] No change                        | Panel-mount SPST 12V                     | Same<br>Link (Before): https://robu.in/product/ks-01-101c-key-switch-12mm-2-positionon-off<br>Link (After): Same as Before                                                            | Standard sourcing                                                 | ₹0                                                |
| **Sabot**                   | [OK] Validate only                    | 3D-printed PETG 52 mm OD                 | Same (**verify caliper: 52±0.2 mm after print**)<br>Link (Before): https://3ding.in/<br>Link (After): Same as Before                                                                  | Add QC check                                                      | ₹0                                                |
| **O-Ring Kit**              | [SUBSTITUTED] **SUBSTITUTED**             | **AASONS Nitrile 100-piece ₹649** | **PTFE assortment 200+ pieces ₹400–650**<br>Link (Before): [ADD OLD NITRILE LINK]<br>Link (After): https://www.amazon.in/s?k=PTFE+o-ring+assortment+metric                           | **NBR fails <−15°C; PTFE required for CO₂ duty**         | **₹0 to −₹250 (cost neutral or cheaper)** |
| **PU Tubing**               | [OK] No change                        | 6 mm OD × 4 mm ID 15 bar                | Same<br>Link (Before): https://www.indiamart.com/proddetail/blue-polyurethane-pu-pneumatic-air-tubing-22370271588.html<br>Link (After): Same as Before                               | Standard sourcing                                                 | ₹0                                                |
| **Silicone Wiring**         | [OK] Emphasized                       | 22 AWG −40°C rated                     | Same (**mandate silicone, not PVC**)<br>Link (Before): https://robu.in/product/high-quality-ultra-flexible-22awg-silicone-wire-1000m-red<br>Link (After): Same as Before             | Cold-duty requirement                                             | ₹0                                                |
| **Carbon Fibre Frame**      | [OK] No change                        | 3-inch folding quadcopter                | Same (clarify pricing: ₹1,200–1,800, not ₹10,000)<br>Link (Before): https://hitechxyz.in/products/speedybee-mario-fold-8-dc-long-range-drone<br>Link (After): Same as Before         | Standard sourcing                                                 | ₹0                                                |
| **AIO FC + ESC**            | [OK] Emphasized                       | SpeedyBee F405 Mini                      | Same (**add vibration damping mount requirement**)<br>Link (Before): https://www.electropi.in/speedybee-f405-mini-2020-flight-controller<br>Link (After): Same as Before            | Launch-shock protection                                           | ₹0 (damping cost ~₹200 included elsewhere)       |
| **Brushless Motors**        | [OK] Verified                         | BetaFPV 1103 6000KV                      | Same (**verify 2 mm shaft; buy 2 spares**)<br>Link (Before): https://www.electropi.in/happy-model-ex1103-kv11000-brushless-motor-cw<br>Link (After): Same as Before                | Standard sourcing + spares                                        | ₹0                                                |
| **Propellers**              | [OK] No change                        | Gemfan 3016 3-inch                       | Same (**buy 2 sets = 8 total**)<br>Link (Before): https://www.uavmarketplace.in/products/gemfan-3016-hurricane-pc-2l2r-3-blade-propeller/895789000000938970<br>Link (After): Same as Before | Standard sourcing                                                 | ₹0                                                |
| **FPV Camera**              | [OK] Emphasized                       | RunCam Nano 4                            | Same (**add TPU damped mount requirement**)<br>Link (Before): https://www.electropi.in/runcam-nano-4-camera-for-fpv-drone<br>Link (After): Same as Before                           | Launch-shock protection                                           | ₹0 (mount cost ~₹100–200 included)              |
| **3S LiPo (UAV)**           | [OK] Emphasized                       | 300–450 mAh strip format                | Same (**mandate strip format for CG alignment**)<br>Link (Before): https://www.quadkart.in/product-category/lipo-battery/drone-battery/3s-lipo-battery/<br>Link (After): Same as Before | Stability requirement                                             | ₹0                                                |
| **Vision / Comms Board**    | [FALLBACK_ADDED] **FALLBACK ADDED**          | **OpenMV H7 Plus ₹6,500–12,270** | **PRIMARY (if available): OpenMV H7 Plus \| FALLBACK (if delayed >2 weeks): ESP32-S3 ₹500–700**<br>Link (Before): https://openmv.io/products/openmv-h7-plus<br>Link (After): [ADD FINAL CHOSEN LINK] | **Availability risk; fallback enables immediate prototype** | **−₹11,500–12,000 if fallback used**      |
| **Anti-vibration Hardware** | [OK] Emphasized                       | M2 nylon + silicone + foam               | Same (**mandate vibration isolation for IMU**)<br>Link (Before): https://indianrobostore.com/product/320pcs-m2-black-nylon-hex-spacer-standoff-kit-with-nuts<br>Link (After): Same as Before | Launch-shock protection                                           | ₹0                                                |
